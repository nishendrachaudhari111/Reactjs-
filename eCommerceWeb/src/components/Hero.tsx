...
export const Hero = () => {
  return (
    <div className="container pt-8">
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4 ">
            ...
            <h2 className="text-2xl sm:text md:text-6xl font-nold">
              Dried Fruits Best Quality
            </h2>
            <p className="text-gray-500 text-xl pt-4 sm:pt-8">Starting At</p>
            <div className="font-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 ph-4">
              $18.36
            </div>
            <div className="bg-accentDark hover:bg-accent text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-[14px] sm:py-6 sm:px-3 cursor-pointer">
              Shop Now
              <BsArrowRight />
            </div>
          </div>
      ...
      <div className="absolute top-20 right-8 mt-8 mr-8">
        <img
      ...
      <div className="absolute top-[60%] right-8 mt-8 mr-8">
        <img
          className="w-300 h-300 object-cover rounded-lg"
